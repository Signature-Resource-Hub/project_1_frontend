...
class Reviewss extends StatefulWidget {
  final String hotelid;
  const Reviewss({Key? key, required this.hotelid});

  @override
  State<Reviewss> createState() => _ReviewPageState();
}

class _ReviewPageState extends State<Reviewss> {
