...
import 'package:project_1_frontend/pages/hotelpayments.dart';
import 'package:project_1_frontend/pages/payment.dart';
import 'package:project_1_frontend/services/bookhotels.dart';
        ...
        return AlertDialog(
          ...
          actions: <Widget>[
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => Payment(totalAmount: _priceAfterDiscount)));
              },
