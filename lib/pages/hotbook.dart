...
// import 'package:project_1_frontend/pages/room_select.dart';
...
// // void _navigateToRoomSelectionPage(DateTime? _selectedStartDate) {
...
// //           checkOutTime: widget.checkOutTime,
// //           numberOfNights: numberOfNights,
// //           checkInDate: _selectedStartDate, // Pass the selected check-in date
// //           checkOutDate: _selectedEndDate, // Pass the selected check-out date
// //         ),
// //       ),
// //     );
// //   } else {
// //     // Handle case where selectedCheckInDate is null
...
//                   setState(() {
//                     _selectedStartDate = start ?? DateTime.now(); // Handling nullable start date
//                     _selectedEndDate = end ?? DateTime.now(); // Handling nullable end date
//                     _calculateCost();
//                   });
//                 },
...
//                   rangeEndDecoration: BoxDecoration(color: Colors.blue),
