...
// Text(
//   'Ac NonAc : ${_bookings[index]['acNonAc']}', 
//   style: TextStyle(
//     fontSize: 14,
//     color: Colors.green,
//   ),
...
class _BookingDetailScreenState extends State<BookingDetailScreen> {
  ...
  Future<void> _cancel(String bookingId) async {
    bool confirm = await _showConfirmationDialog(bookingId);
    if (confirm) {
      try {
        await _displayService.cancelBooking(bookingId);
        setState(() {
        ...
        return Card(
          ...
          child: InkWell(
            onTap: () {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => ReviewPage(bookingDetails: booking)),
              );
            },
            child: Padding(
              padding: const EdgeInsets.all(16.0),
                ...
                children: [
                  Flexible(
                    child: Column(
                      ...
                      children: [
                        Text(
                          'Hotel Name: ${_bookings[index]['hotelName']}',
                          style: TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.bold,
                            color: Colors.teal,
                        ...
                        Row(
                          children: [
                            ...
                            SizedBox(width: 16),
                            // Text(
                            //   'AC/Non-AC: ${_bookings[index]['acNonAc']}',
                            //   style: TextStyle(
                            //     fontSize: 14,
                            //     color: Colors.green,
                            //   ),
                  ...
                  ElevatedButton(
                    onPressed: () async {
                      await _cancel(_bookings[index]['bookingId']);
                    },
                    child: Text('Cancel'),
                    style: ElevatedButton.styleFrom(
                      primary: Colors.red,
